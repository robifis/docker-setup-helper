...
description: Help beginners set up Docker apps from GitHub repositories. Use when the user provides a GitHub repo or local project and wants Docker deployment help, including repo inspection, Docker/Compose checks, .env preparation, port conflict planning, health checks, beginner runbooks, and safe approval-gated compose changes.
---
